		...
		<div class="body content rows scroll-y">
			...
			<div class="row">
				<ul class="nav nav-tabs">
					<li class="active"><a href="#home">Kategorileri Listele</a></li>
					<li><a href="#menu1">Kategori Ekle</a></li>
				</ul>
				<div class="tab-content">
					<div id="home" class="tab-pane fade in active">
						<ul class="nav nav-tabs">
							<li class="active"><a href="#ust">Üst Kategoriler</a></li>
							<li><a href="#alt">Alt Kategoriler</a></li>
							<li><a href="#ealt">En Alt Kategoriler</a></li>
						</ul>
						<div class="tab-content">
							<div id="ust" class="tab-pane fade in active">
								<ul class="nav nav-tabs">
									<h3>Üst Kategoriler</h3>
       						 ...
       						 SELECT * FROM kategoriler WHERE status='UST';
   		 					</sql:query>
							...
							<div id="alt" class="tab-pane fade ">
								<ul class="nav nav-tabs">
									...
									<sql:setDataSource var="db" driver="org.postgresql.Driver"
										...
										password="1234" />
									<sql:query var="listUrun" dataSource="${db}">
       						 SELECT * FROM kategoriler WHERE status='ALT';
   		 					</sql:query>
									<div id="sales-report" class="collapse in">
										<div class="table-responsive">
											<table data-sortable="" class="table table-striped"
												...
												<tbody>
													<c:forEach var="urun" items="${listUrun.rows}">
														<tr>
															<td><c:out value="${urun.id}" /></td>
															<td><c:out value="${urun.catname}" /></td>
															<td><c:out value="${urun.ustcatid}" /></td>
														</tr>
													</c:forEach>
												</tbody>
											</table>
							...
							<div id="ealt" class="tab-pane fade ">
								<ul class="nav nav-tabs">
									<h3>En Alt Kategoriler</h3>
									<sql:setDataSource var="db" driver="org.postgresql.Driver"
										url="jdbc:postgresql://localhost:5432" user="postgres"
										password="1234" />
									<sql:query var="listUrun" dataSource="${db}">
					...
					<div id="menu1" class="tab-pane fade">
						<ul class="nav nav-tabs">
							<li class="active"><a href="#ustcat">Üst Kategori Ekle</a></li>
							<li><a href="#altcat">Alt Kategori Ekle</a></li>
						</ul>
						<div class="tab-content">
							<div id="ustcat" class="tab-pane fade in active">
								<br>
								<div class="row">
									<div class="col-sm-3 col-md-6">
										<div id="contact_form">
											<form action="KategoriEkle">
												<p>
													<label for="countryCode">Üst Kategori Ekle:</label><br />
