...
/**
 * Servlet implementation class TumUrunler
 */
@WebServlet("/TumUrunler")
public class TumUrunler extends HttpServlet {
	private static final long serialVersionUID = 1L;
	
	private static Logger logger = LoggerFactory.getLogger(TumUrunler.class);
